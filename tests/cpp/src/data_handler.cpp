...
void DataHandler::filter_bandpass (double **data, int data_count, float min_cutoff, float max_cutoff)
{
...
void DataHandler::preprocess_data (double **data, int data_count, float min_cutoff, float max_cutoff, float dc_offset)
{
