            ...
            switch (i)
            {
                ...
                case 0:
                    DataFilter::perform_rolling_filter (data.get_address (eeg_channels[i]),
                        data.get_size (0), 3, (int)AggOperations::MEDIAN);
                    break;
                case 1:
                    DataFilter::perform_rolling_filter (data.get_address (eeg_channels[i]),
                        data.get_size (0), 3, (int)AggOperations::MEAN);
                    break;
                case 2:
                    DataFilter::perform_rolling_filter (data.get_address (eeg_channels[i]),
                        data.get_size (0), 5, (int)AggOperations::MEDIAN);
                    break;
                case 3:
                    DataFilter::perform_rolling_filter (data.get_address (eeg_channels[i]),
                        data.get_size (0), 5, (int)AggOperations::MEAN);
                    break;
                ...
                case 4:
                    DataFilter::perform_wavelet_denoising (
                        data.get_address (eeg_channels[i]), data.get_size (0), "db4", 3);
                    break;
                case 5:
                    DataFilter::perform_wavelet_denoising (
                        data.get_address (eeg_channels[i]), data.get_size (0), "coif3", 3);
                    break;
            }
        }
