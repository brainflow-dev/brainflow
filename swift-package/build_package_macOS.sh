...
xcodebuild -create-xcframework -library ../lib/libBrainBitLib.dylib  -output BrainBitLib.xcframework
xcodebuild -create-xcframework -library ../lib/libDataHandler.dylib  -output DataHandler.xcframework
xcodebuild -create-xcframework -library ../lib/libMLModule.dylib  -output MLModule.xcframework
