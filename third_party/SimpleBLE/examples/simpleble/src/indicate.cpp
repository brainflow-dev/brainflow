...
int main() {
    ...
    selection = Utils::getUserInputInt("Please select a characteristic to indicate", uuids.size() - 1);
    ...
    peripheral.indicate(uuids[selection.value()].first, uuids[selection.value()].second,
