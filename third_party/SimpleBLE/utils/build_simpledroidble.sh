...
SOURCE_PATH=$PROJECT_ROOT/simpledroidble
BUILD_PATH=$PROJECT_ROOT/build_simpledroidble

EXAMPLES_PATH=$PROJECT_ROOT/examples/simpleble-android
EXAMPLES_BUILD_PATH=$PROJECT_ROOT/build_simpleble_android
