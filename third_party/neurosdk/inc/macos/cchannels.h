...
SDK_SHARED void free_length_listener_handle(LengthListenerHandle handle);
...
SDK_SHARED int AnyChannel_add_length_callback(AnyChannel *channel, void(*callback)(AnyChannel *, size_t, void *), LengthListenerHandle *handle, void *user_data);
