...
SDK_SHARED int EegIndexChannel_get_base_power_left(EegIndexChannel *channel, double *out_power);
SDK_SHARED int EegIndexChannel_get_base_power_right(EegIndexChannel *channel, double *out_power);
...
SDK_SHARED int EmotionalStateChannel_get_base_state_values(EmotionalStateChannel *channel, BaseEmotionalValue *out_base_value);
...
SDK_SHARED int MeditationAnalyzer_level_progress(MeditationAnalyzer* analyzer, double* out_level_progress);
SDK_SHARED int MeditationAnalyzer_set_level_changed_callback(MeditationAnalyzer*, void(*)(MeditationAnalyzer*, int, void*), MeditationLevelListener*, void* user_data);
SDK_SHARED int MeditationAnalyzer_set_level_progress_changed_callback(MeditationAnalyzer*, void(*)(MeditationAnalyzer*, double, void*), MeditationLevelProgressListener*, void* user_data);
