...
typedef void* SignalListenerHandle;
SDK_SHARED void free_signal_listener_handle(SignalListenerHandle handle);
	
SDK_SHARED int device_subscribe_signal_channel_data_received(Device*, ChannelInfo, void(*)(Device*, ChannelInfo, SignalDataArray, void *), SignalListenerHandle *, void *user_data);
