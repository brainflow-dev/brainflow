...
namespace ffft
{
    ...
    */
    ...
    template <class DT> long FFTReal<DT>::get_length () const
    {
        return (_length);
    }
    ...
    */
    ...
    template <class DT> void FFTReal<DT>::rescale (DataType x[]) const
    {
    ...
    */
    ...
    template <class DT> typename FFTReal<DT>::DataType *FFTReal<DT>::use_buffer () const
    {
        return (&_buffer[0]);
    }
    ...
    template <class DT> void FFTReal<DT>::init_trigo_lut ()
    {
        using namespace std;
    ...
    template <class DT> void FFTReal<DT>::init_trigo_osc ()
    {
    ...
    template <class DT> const long *FFTReal<DT>::get_br_ptr () const
    {
        return (&_br_lut[0]);
    }
