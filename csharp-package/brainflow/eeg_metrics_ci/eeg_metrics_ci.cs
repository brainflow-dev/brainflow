...
namespace test
{
    class EEGMetricsCi
    {
        static void Main (string[] args)
        {
            ...
            int sampling_rate = BoardShim.get_sampling_rate (board_shim.get_master_board_id());
            int nfft = DataFilter.get_nearest_power_of_two(sampling_rate);
            int[] eeg_channels = BoardShim.get_eeg_channels(board_shim.get_master_board_id());
