...
- Join our `slack workspace <https://openbraintalk.slack.com/>`_ using `self\-invite page <https://communityinviter.com/apps/openbraintalk/join-brainflow-on-slack>`_. Use **\#askhelp** channel for your questions.
