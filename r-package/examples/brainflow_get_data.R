...
board_shim <- get_board_shim(Boards()$Ganglion["Type"], "")
...
data_handler <- get_data_handler(Boards()$Ganglion["Type"], numpy_data = data)
...
head(get_data(get_data_handler(Boards()$Ganglion["Type"], csv_file = "results.csv")))
