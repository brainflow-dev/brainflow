...
board_shim <- get_board_shim(Boards()$Synthetic["Type"], "")
...
data_handler <- get_data_handler(Boards()$Synthetic["Type"], numpy_data = data)
...
head(get_data(get_data_handler(Boards()$Synthetic["Type"], csv_file = "results.csv")))
