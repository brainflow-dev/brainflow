...
def main ():
    ...
    parser.add_argument ('--board', type = int, help  = 'board id, Ganglion - 1, Cyton - 0', required = True)
    ...
    read_data = brainflow.preprocess.DataHandler (args.board, csv_file = 'results.csv')
