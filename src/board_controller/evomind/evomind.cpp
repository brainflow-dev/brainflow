...
Evomind::Evomind (struct BrainFlowInputParams params)
    : Board ((int)BoardIds::EVOMIND_BOARD, params)
{
...
int Evomind::prepare_session ()
{
    ...
    {
        safe_logger (
            spdlog::level::warn, "mac address is not provided, trying to autodiscover evomind");
        int res = find_evomind_addr ();
