...
if (MSVC)
    ...
    file (COPY "${CMAKE_HOME_DIRECTORY}/third_party/ant_neuro/windows/${ANT_LIB_NAME}" DESTINATION "${CMAKE_HOME_DIRECTORY}/swift-package/brainflow/lib/")
endif (MSVC)
if (UNIX AND NOT APPLE AND NOT ANDROID)
    ...
    file (COPY "${CMAKE_HOME_DIRECTORY}/third_party/ant_neuro/linux/${ANT_LIB_NAME}" DESTINATION "${CMAKE_HOME_DIRECTORY}/swift-package/brainflow/lib/")
endif (UNIX AND NOT APPLE AND NOT ANDROID)
