...
#define BG_ERRORCODES
    ...
    typedef enum ble_error
    {
        ...
        ble_err_bt_bt_error_authentication_failure = ble_errspc_bt +
            5, // Pairing or authentication failed due to incorrect results in the pairing or
               // authentication procedure. This could be due to an incorrect PIN or Link Key
        ble_err_bt_pin_or_key_missing =
            ble_errspc_bt + 6, // Pairing failed because of missing PIN, or authentication failed
                               // because of missing Key
        ble_err_bt_bt_error_memory_capacity_exceeded =
            ble_errspc_bt + 7,                             // Controller is out of memory.
        ble_err_bt_connection_timeout = ble_errspc_bt + 8, // Link supervision timeout has expired.
        ble_err_bt_connection_limit_exceeded =
            ble_errspc_bt + 9, // Controller is at limit of connections it can support.
        ble_err_bt_bt_error_command_disallowed =
            ble_errspc_bt + 12, // Command requested cannot be executed because the Controller is in
                                // a state where it cannot process this command at this time.
        ble_err_bt_bt_error_invalid_command_parameters =
            ble_errspc_bt + 18, // Command contained invalid parameters.
        ble_err_bt_bt_error_remote_user_terminated =
            ble_errspc_bt + 19, // User on the remote device terminated the connection.
        ble_err_bt_bt_error_connection_terminated_by_local_host =
            ble_errspc_bt + 22, // Local device terminated the connection.
        ble_err_bt_bt_error_ll_response_timeout =
            ble_errspc_bt + 34, // Connection terminated due to link-layer procedure timeout.
        ble_err_bt_bt_error_ll_instant_passed =
            ble_errspc_bt + 40, // Received link-layer control packet where instant was in the past.
        ble_err_bt_bt_error_controller_busy =
            ble_errspc_bt + 58, // Operation was rejected because the controller is busy and unable
                                // to process the request.
        ble_err_bt_bt_error_unacceptable_connection_interval =
            ble_errspc_bt + 59, // Remote evice terminated the connection because of an unacceptable
                                // connection interval.
        ble_err_bt_bt_error_directed_advertising_timeout = ble_errspc_bt +
            60, // Directed advertising completed without a connection being created.
        ble_err_bt_bt_error_connection_terminated_due_to_mic_failure =
            ble_errspc_bt + 61, // Connection was terminated because the Message Integrity Check
                                // (MIC) failed on a received packet.
        ble_err_bt_bt_error_connection_failed_to_be_established = ble_errspc_bt +
            62, // LL initiated a connection but the connection has failed to be established.
                // Controller did not receive any packets from remote end.
        ble_err_att_invalid_handle =
            ble_errspc_att + 1, // The attribute handle given was not valid on this server
        ...
        ble_err_att_insufficient_authentication = ble_errspc_att +
            5, // The attribute requires authentication before it can be read or written.
        ble_err_att_request_not_supported = ble_errspc_att +
            6, // Attribute Server does not support the request received from the client.
        ble_err_att_invalid_offset =
            ble_errspc_att + 7, // Offset specified was past the end of the attribute
        ble_err_att_insufficient_authorization = ble_errspc_att +
            8, // The attribute requires authorization before it can be read or written.
        ble_err_att_prepare_queue_full =
            ble_errspc_att + 9, // Too many prepare writes have been queueud
        ble_err_att_att_not_found =
            ble_errspc_att + 10, // No attribute found within the given attribute handle range.
        ble_err_att_att_not_long = ble_errspc_att +
            11, // The attribute cannot be read or written using the Read Blob Request
        ble_err_att_insufficient_enc_key_size = ble_errspc_att +
            12, // The Encryption Key Size used for encrypting this link is insufficient.
        ble_err_att_invalid_att_length =
            ble_errspc_att + 13, // The attribute value length is invalid for the operation
        ble_err_att_unlikely_error = ble_errspc_att +
            14, // The attribute request that was requested has encountered an error that was
                // unlikely, and therefore could not be completed as requested.
        ble_err_att_insufficient_encryption = ble_errspc_att +
            15, // The attribute requires encryption before it can be read or written.
        ble_err_att_unsupported_group_type =
            ble_errspc_att + 16, // The attribute type is not a supported grouping attribute as
                                 // defined by a higher layer specification.
        ble_err_att_insufficient_resources =
            ble_errspc_att + 17, // Insufficient Resources to complete the request
        ble_err_att_application =
            ble_errspc_att + 128, // Application error code defined by a higher layer specification.
        ...
        ble_err_not_connected =
            ble_errspc_bg + 134, // Connection handle passed is to command is not a valid handle
        ble_err_flow =
            ble_errspc_bg + 135, // Command would cause either underflow or overflow error
        ble_err_user_attribute =
            ble_errspc_bg + 136, // User attribute was accessed through API which is not supported
        ...
        ble_err_out_of_bonds = ble_errspc_bg +
            139, // Bonding procedure can't be started because device has no space left for bond.
        ble_err_smp_passkey_entry_failed = ble_errspc_smp +
            1, // The user input of passkey failed, for example, the user cancelled the operation
        ble_err_smp_oob_not_available =
            ble_errspc_smp + 2, // Out of Band data is not available for authentication
        ble_err_smp_authentication_requirements = ble_errspc_smp +
            3, // The pairing procedure cannot be performed as authentication requirements cannot be
               // met due to IO capabilities of one or both devices
        ble_err_smp_confirm_value_failed =
            ble_errspc_smp + 4, // The confirm value does not match the calculated compare value
        ble_err_smp_pairing_not_supported =
            ble_errspc_smp + 5, // Pairing is not supported by the device
        ble_err_smp_encryption_key_size =
            ble_errspc_smp + 6, // The resultant encryption key size is insufficient for the
                                // security requirements of this device
        ble_err_smp_command_not_supported =
            ble_errspc_smp + 7, // The SMP command received is not supported on this device
        ble_err_smp_unspecified_reason =
            ble_errspc_smp + 8, // Pairing failed due to an unspecified reason
        ble_err_smp_repeated_attempts = ble_errspc_smp +
            9, // Pairing or authentication procedure is disallowed because too little time has
               // elapsed since last pairing request or security request
        ble_err_smp_invalid_parameters =
            ble_errspc_smp + 10, // The Invalid Parameters error code indicates: the command length
                                 // is invalid or a parameter is outside of the specified range.
        ble_err_last
    } errorcode_t;
#endif
    PACKSTRUCT (struct ble_msg_system_reset_cmd_t { uint8 boot_in_dfu; });

    PACKSTRUCT (struct ble_msg_system_address_get_rsp_t { bd_addr address; });
    ...
    PACKSTRUCT (struct ble_msg_system_reg_write_rsp_t { uint16 result; });

    PACKSTRUCT (struct ble_msg_system_reg_read_cmd_t { uint16 address; });
    ...
    PACKSTRUCT (struct ble_msg_system_get_connections_rsp_t { uint8 maxconn; });
    ...
    PACKSTRUCT (struct ble_msg_system_endpoint_tx_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_system_whitelist_append_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_system_whitelist_remove_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_system_endpoint_set_watermarks_rsp_t { uint16 result; });

    PACKSTRUCT (struct ble_msg_system_aes_setkey_cmd_t { uint8array key; });

    PACKSTRUCT (struct ble_msg_system_aes_encrypt_cmd_t { uint8array data; });

    PACKSTRUCT (struct ble_msg_system_aes_encrypt_rsp_t { uint8array data; });

    PACKSTRUCT (struct ble_msg_system_aes_decrypt_cmd_t { uint8array data; });

    PACKSTRUCT (struct ble_msg_system_aes_decrypt_rsp_t { uint8array data; });
    ...
    PACKSTRUCT (struct ble_msg_system_debug_evt_t { uint8array data; });
    ...
    PACKSTRUCT (struct ble_msg_system_protocol_error_evt_t { uint16 reason; });
    ...
    PACKSTRUCT (struct ble_msg_flash_ps_save_rsp_t { uint16 result; });

    PACKSTRUCT (struct ble_msg_flash_ps_load_cmd_t { uint16 key; });
    ...
    PACKSTRUCT (struct ble_msg_flash_ps_erase_cmd_t { uint16 key; });

    PACKSTRUCT (struct ble_msg_flash_erase_page_cmd_t { uint8 page; });

    PACKSTRUCT (struct ble_msg_flash_erase_page_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_flash_write_data_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_flash_read_data_rsp_t { uint8array data; });
    ...
    PACKSTRUCT (struct ble_msg_attributes_write_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_attributes_read_type_cmd_t { uint16 handle; });
    ...
    PACKSTRUCT (struct ble_msg_attributes_send_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_connection_disconnect_cmd_t { uint8 connection; });
    ...
    PACKSTRUCT (struct ble_msg_connection_get_rssi_cmd_t { uint8 connection; });
    ...
    PACKSTRUCT (struct ble_msg_connection_version_update_cmd_t { uint8 connection; });
    ...
    PACKSTRUCT (struct ble_msg_connection_channel_map_get_cmd_t { uint8 connection; });
    ...
    PACKSTRUCT (struct ble_msg_connection_features_get_cmd_t { uint8 connection; });
    ...
    PACKSTRUCT (struct ble_msg_connection_get_status_cmd_t { uint8 connection; });

    PACKSTRUCT (struct ble_msg_connection_get_status_rsp_t { uint8 connection; });
    ...
    PACKSTRUCT (struct ble_msg_connection_raw_tx_rsp_t { uint8 connection; });
    ...
    PACKSTRUCT (struct ble_msg_attclient_indicate_confirm_cmd_t { uint8 connection; });

    PACKSTRUCT (struct ble_msg_attclient_indicate_confirm_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_sm_set_bondable_mode_cmd_t { uint8 bondable; });

    PACKSTRUCT (struct ble_msg_sm_delete_bonding_cmd_t { uint8 handle; });

    PACKSTRUCT (struct ble_msg_sm_delete_bonding_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_sm_passkey_entry_rsp_t { uint16 result; });

    PACKSTRUCT (struct ble_msg_sm_get_bonds_rsp_t { uint8 bonds; });

    PACKSTRUCT (struct ble_msg_sm_set_oob_data_cmd_t { uint8array oob; });
    ...
    PACKSTRUCT (struct ble_msg_sm_passkey_request_evt_t { uint8 handle; });
    ...
    PACKSTRUCT (struct ble_msg_gap_set_mode_rsp_t { uint16 result; });

    PACKSTRUCT (struct ble_msg_gap_discover_cmd_t { uint8 mode; });

    PACKSTRUCT (struct ble_msg_gap_discover_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_gap_end_procedure_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_gap_set_filtering_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_gap_set_scan_parameters_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_gap_set_adv_parameters_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_gap_set_adv_data_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_gap_set_directed_connectable_mode_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_io_port_config_irq_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_set_soft_timer_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_adc_read_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_io_port_config_direction_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_io_port_config_function_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_io_port_config_pull_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_io_port_write_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_spi_config_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_i2c_write_rsp_t { uint8 written; });

    PACKSTRUCT (struct ble_msg_hardware_set_txpower_cmd_t { uint8 power; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_timer_comparator_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_io_port_irq_enable_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_io_port_irq_direction_rsp_t { uint16 result; });

    PACKSTRUCT (struct ble_msg_hardware_analog_comparator_enable_cmd_t { uint8 enable; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_analog_comparator_config_irq_cmd_t { uint8 enabled; });

    PACKSTRUCT (struct ble_msg_hardware_analog_comparator_config_irq_rsp_t { uint16 result; });

    PACKSTRUCT (struct ble_msg_hardware_set_rxgain_cmd_t { uint8 gain; });

    PACKSTRUCT (struct ble_msg_hardware_usb_enable_cmd_t { uint8 enable; });

    PACKSTRUCT (struct ble_msg_hardware_usb_enable_rsp_t { uint16 result; });
    ...
    PACKSTRUCT (struct ble_msg_hardware_soft_timer_evt_t { uint8 handle; });
    ...
    PACKSTRUCT (struct ble_msg_test_phy_rx_cmd_t { uint8 channel; });

    PACKSTRUCT (struct ble_msg_test_phy_end_rsp_t { uint16 counter; });

    PACKSTRUCT (struct ble_msg_test_get_channel_map_rsp_t { uint8array channel_map; });

    PACKSTRUCT (struct ble_msg_test_debug_cmd_t { uint8array input; });

    PACKSTRUCT (struct ble_msg_test_debug_rsp_t { uint8array output; });

    PACKSTRUCT (struct ble_msg_test_channel_mode_cmd_t { uint8 mode; });

    PACKSTRUCT (struct ble_msg_dfu_reset_cmd_t { uint8 dfu; });

    PACKSTRUCT (struct ble_msg_dfu_flash_set_address_cmd_t { uint32 address; });

    PACKSTRUCT (struct ble_msg_dfu_flash_set_address_rsp_t { uint16 result; });

    PACKSTRUCT (struct ble_msg_dfu_flash_upload_cmd_t { uint8array data; });

    PACKSTRUCT (struct ble_msg_dfu_flash_upload_rsp_t { uint16 result; });

    PACKSTRUCT (struct ble_msg_dfu_flash_upload_finish_rsp_t { uint16 result; });

    PACKSTRUCT (struct ble_msg_dfu_boot_evt_t { uint32 version; });

    PACKSTRUCT (struct ble_cmd_packet {
        ...
        union {
            ...
            struct ble_msg_attclient_find_information_found_evt_t
                attclient_find_information_found_evt;
            ...
            struct ble_msg_attclient_read_multiple_response_evt_t
                attclient_read_multiple_response_evt;
            ...
            struct ble_msg_gap_set_directed_connectable_mode_cmd_t
                gap_set_directed_connectable_mode_cmd;
            ...
            struct ble_msg_gap_set_directed_connectable_mode_rsp_t
                gap_set_directed_connectable_mode_rsp;
            ...
            struct ble_msg_hardware_io_port_config_direction_cmd_t
                hardware_io_port_config_direction_cmd;
            struct ble_msg_hardware_io_port_config_function_cmd_t
                hardware_io_port_config_function_cmd;
            ...
            struct ble_msg_hardware_analog_comparator_enable_cmd_t
                hardware_analog_comparator_enable_cmd;
            struct ble_msg_hardware_analog_comparator_config_irq_cmd_t
                hardware_analog_comparator_config_irq_cmd;
            ...
            struct ble_msg_hardware_analog_comparator_status_evt_t
                hardware_analog_comparator_status_evt;
            ...
            struct ble_msg_hardware_io_port_config_direction_rsp_t
                hardware_io_port_config_direction_rsp;
            struct ble_msg_hardware_io_port_config_function_rsp_t
                hardware_io_port_config_function_rsp;
            ...
            struct ble_msg_hardware_analog_comparator_read_rsp_t
                hardware_analog_comparator_read_rsp;
            struct ble_msg_hardware_analog_comparator_config_irq_rsp_t
                hardware_analog_comparator_config_irq_rsp;
...
/**write register**/
#define ble_cmd_system_reg_write(address, value)                                                   \
    ble_send_message (ble_cmd_system_reg_write_idx, address, value)
/**read register**/
...
/**Read Memory**/
#define ble_cmd_system_read_memory(address, length)                                                \
    ble_send_message (ble_cmd_system_read_memory_idx, address, length)
/**Get Device info**/
...
#define ble_cmd_system_endpoint_tx(endpoint, data_len, data_data)                                  \
    ble_send_message (ble_cmd_system_endpoint_tx_idx, endpoint, data_len, data_data)
/**Add entry to whitelist**/
#define ble_cmd_system_whitelist_append(address, address_type)                                     \
    ble_send_message (ble_cmd_system_whitelist_append_idx, address, address_type)
/**Remove entry from whitelist**/
#define ble_cmd_system_whitelist_remove(address, address_type)                                     \
    ble_send_message (ble_cmd_system_whitelist_remove_idx, address, address_type)
/**Add entry to whitelist**/
...
#define ble_cmd_system_endpoint_rx(endpoint, size)                                                 \
    ble_send_message (ble_cmd_system_endpoint_rx_idx, endpoint, size)
/**Set watermarks on both input and output side**/
#define ble_cmd_system_endpoint_set_watermarks(endpoint, rx, tx)                                   \
    ble_send_message (ble_cmd_system_endpoint_set_watermarks_idx, endpoint, rx, tx)
/**Set encryption key that will be used with aes_encrypt and aes_decrypt commands.**/
#define ble_cmd_system_aes_setkey(key_len, key_data)                                               \
    ble_send_message (ble_cmd_system_aes_setkey_idx, key_len, key_data)
/**Encrypt one block of data**/
#define ble_cmd_system_aes_encrypt(data_len, data_data)                                            \
    ble_send_message (ble_cmd_system_aes_encrypt_idx, data_len, data_data)
/**Decrypt one block of data**/
#define ble_cmd_system_aes_decrypt(data_len, data_data)                                            \
    ble_send_message (ble_cmd_system_aes_decrypt_idx, data_len, data_data)
...
/**save ps key**/
#define ble_cmd_flash_ps_save(key, value_len, value_data)                                          \
    ble_send_message (ble_cmd_flash_ps_save_idx, key, value_len, value_data)
/**load ps key**/
...
#define ble_cmd_flash_write_data(address, data_len, data_data)                                     \
    ble_send_message (ble_cmd_flash_write_data_idx, address, data_len, data_data)
/**read data from user data area.**/
#define ble_cmd_flash_read_data(address, length)                                                   \
    ble_send_message (ble_cmd_flash_read_data_idx, address, length)
/**Write to attribute database**/
#define ble_cmd_attributes_write(handle, offset, value_len, value_data)                            \
    ble_send_message (ble_cmd_attributes_write_idx, handle, offset, value_len, value_data)
/**Read from attribute database**/
#define ble_cmd_attributes_read(handle, offset)                                                    \
    ble_send_message (ble_cmd_attributes_read_idx, handle, offset)
/**Read attribute type from database**/
#define ble_cmd_attributes_read_type(handle)                                                       \
    ble_send_message (ble_cmd_attributes_read_type_idx, handle)
/**Respond to user attribute read request**/
#define ble_cmd_attributes_user_read_response(connection, att_error, value_len, value_data)        \
    ble_send_message (                                                                             \
        ble_cmd_attributes_user_read_response_idx, connection, att_error, value_len, value_data)
/**Response to attribute_changed event where reason is user-attribute write.**/
#define ble_cmd_attributes_user_write_response(connection, att_error)                              \
    ble_send_message (ble_cmd_attributes_user_write_response_idx, connection, att_error)
/**Send notification or indication to remote device.**/
#define ble_cmd_attributes_send(connection, handle, value_len, value_data)                         \
    ble_send_message (ble_cmd_attributes_send_idx, connection, handle, value_len, value_data)
/**Disconnect connection, starts a disconnection procedure on connection**/
#define ble_cmd_connection_disconnect(connection)                                                  \
    ble_send_message (ble_cmd_connection_disconnect_idx, connection)
/**Get Link RSSI**/
#define ble_cmd_connection_get_rssi(connection)                                                    \
    ble_send_message (ble_cmd_connection_get_rssi_idx, connection)
/**Update connection parameters**/
#define ble_cmd_connection_update(connection, interval_min, interval_max, latency, timeout)        \
    ble_send_message (                                                                             \
        ble_cmd_connection_update_idx, connection, interval_min, interval_max, latency, timeout)
/**Request version exchange**/
#define ble_cmd_connection_version_update(connection)                                              \
    ble_send_message (ble_cmd_connection_version_update_idx, connection)
/**Get Current channel map**/
#define ble_cmd_connection_channel_map_get(connection)                                             \
    ble_send_message (ble_cmd_connection_channel_map_get_idx, connection)
/**Set Channel map**/
#define ble_cmd_connection_channel_map_set(connection, map_len, map_data)                          \
    ble_send_message (ble_cmd_connection_channel_map_set_idx, connection, map_len, map_data)
/**Remote feature request**/
#define ble_cmd_connection_features_get(connection)                                                \
    ble_send_message (ble_cmd_connection_features_get_idx, connection)
/**Get Connection Status Parameters**/
#define ble_cmd_connection_get_status(connection)                                                  \
    ble_send_message (ble_cmd_connection_get_status_idx, connection)
/**Raw TX**/
#define ble_cmd_connection_raw_tx(connection, data_len, data_data)                                 \
    ble_send_message (ble_cmd_connection_raw_tx_idx, connection, data_len, data_data)
/**Discover attributes by type and value**/
#define ble_cmd_attclient_find_by_type_value(connection, start, end, uuid, value_len, value_data)  \
    ble_send_message (ble_cmd_attclient_find_by_type_value_idx, connection, start, end, uuid,      \
        value_len, value_data)
/**Discover attributes by type and value**/
#define ble_cmd_attclient_read_by_group_type(connection, start, end, uuid_len, uuid_data)          \
    ble_send_message (                                                                             \
        ble_cmd_attclient_read_by_group_type_idx, connection, start, end, uuid_len, uuid_data)
/**Read all attributes where type matches**/
#define ble_cmd_attclient_read_by_type(connection, start, end, uuid_len, uuid_data)                \
    ble_send_message (                                                                             \
        ble_cmd_attclient_read_by_type_idx, connection, start, end, uuid_len, uuid_data)
/**Discover Attribute handle and type mappings**/
#define ble_cmd_attclient_find_information(connection, start, end)                                 \
    ble_send_message (ble_cmd_attclient_find_information_idx, connection, start, end)
/**Read Characteristic value using handle**/
#define ble_cmd_attclient_read_by_handle(connection, chrhandle)                                    \
    ble_send_message (ble_cmd_attclient_read_by_handle_idx, connection, chrhandle)
/**write data to attribute**/
#define ble_cmd_attclient_attribute_write(connection, atthandle, data_len, data_data)              \
    ble_send_message (                                                                             \
        ble_cmd_attclient_attribute_write_idx, connection, atthandle, data_len, data_data)
/**write data to attribute using ATT write command**/
#define ble_cmd_attclient_write_command(connection, atthandle, data_len, data_data)                \
    ble_send_message (                                                                             \
        ble_cmd_attclient_write_command_idx, connection, atthandle, data_len, data_data)
/**Send confirmation for received indication, use only if manual indications are enabled**/
#define ble_cmd_attclient_indicate_confirm(connection)                                             \
    ble_send_message (ble_cmd_attclient_indicate_confirm_idx, connection)
/**Read Long Characteristic value**/
#define ble_cmd_attclient_read_long(connection, chrhandle)                                         \
    ble_send_message (ble_cmd_attclient_read_long_idx, connection, chrhandle)
/**Send prepare write request to remote host**/
#define ble_cmd_attclient_prepare_write(connection, atthandle, offset, data_len, data_data)        \
    ble_send_message (                                                                             \
        ble_cmd_attclient_prepare_write_idx, connection, atthandle, offset, data_len, data_data)
/**Send prepare write request to remote host**/
#define ble_cmd_attclient_execute_write(connection, commit)                                        \
    ble_send_message (ble_cmd_attclient_execute_write_idx, connection, commit)
/**Read multiple attributes from server**/
#define ble_cmd_attclient_read_multiple(connection, handles_len, handles_data)                     \
    ble_send_message (ble_cmd_attclient_read_multiple_idx, connection, handles_len, handles_data)
/**Enable encryption on link**/
#define ble_cmd_sm_encrypt_start(handle, bonding)                                                  \
    ble_send_message (ble_cmd_sm_encrypt_start_idx, handle, bonding)
/**Set device to bondable mode**/
#define ble_cmd_sm_set_bondable_mode(bondable)                                                     \
    ble_send_message (ble_cmd_sm_set_bondable_mode_idx, bondable)
...
#define ble_cmd_sm_set_parameters(mitm, min_key_size, io_capabilities)                             \
    ble_send_message (ble_cmd_sm_set_parameters_idx, mitm, min_key_size, io_capabilities)
/**Passkey entered**/
#define ble_cmd_sm_passkey_entry(handle, passkey)                                                  \
    ble_send_message (ble_cmd_sm_passkey_entry_idx, handle, passkey)
...
/**
            ...
            **/
#define ble_cmd_sm_set_oob_data(oob_len, oob_data)                                                 \
    ble_send_message (ble_cmd_sm_set_oob_data_idx, oob_len, oob_data)
/**
 ...
 **/
#define ble_cmd_gap_set_privacy_flags(peripheral_privacy, central_privacy)                         \
    ble_send_message (ble_cmd_gap_set_privacy_flags_idx, peripheral_privacy, central_privacy)
/**Set discoverable and connectable mode**/
#define ble_cmd_gap_set_mode(discover, connect)                                                    \
    ble_send_message (ble_cmd_gap_set_mode_idx, discover, connect)
...
#define ble_cmd_gap_connect_direct(                                                                \
    address, addr_type, conn_interval_min, conn_interval_max, timeout, latency)                    \
    ble_send_message (ble_cmd_gap_connect_direct_idx, address, addr_type, conn_interval_min,       \
...
#define ble_cmd_gap_connect_selective(conn_interval_min, conn_interval_max, timeout, latency)      \
    ble_send_message (                                                                             \
        ble_cmd_gap_connect_selective_idx, conn_interval_min, conn_interval_max, timeout, latency)
/**Set scan and advertising filtering parameters**/
#define ble_cmd_gap_set_filtering(scan_policy, adv_policy, scan_duplicate_filtering)               \
    ble_send_message (                                                                             \
        ble_cmd_gap_set_filtering_idx, scan_policy, adv_policy, scan_duplicate_filtering)
/**Set scan parameters**/
#define ble_cmd_gap_set_scan_parameters(scan_interval, scan_window, active)                        \
    ble_send_message (ble_cmd_gap_set_scan_parameters_idx, scan_interval, scan_window, active)
/**Set advertising parameters**/
#define ble_cmd_gap_set_adv_parameters(adv_interval_min, adv_interval_max, adv_channels)           \
    ble_send_message (                                                                             \
        ble_cmd_gap_set_adv_parameters_idx, adv_interval_min, adv_interval_max, adv_channels)
/**Set advertisement or scan response data. Use broadcast mode to advertise data**/
#define ble_cmd_gap_set_adv_data(set_scanrsp, adv_data_len, adv_data_data)                         \
    ble_send_message (ble_cmd_gap_set_adv_data_idx, set_scanrsp, adv_data_len, adv_data_data)
/**Sets device to Directed Connectable Mode
                        Uses fast advertisement procedure for 1.28s after which device enters
   nonconnectable mode. If device has valid reconnection characteristic value, it is used for
   connection otherwise passed address and address type are used
            **/
#define ble_cmd_gap_set_directed_connectable_mode(address, addr_type)                              \
    ble_send_message (ble_cmd_gap_set_directed_connectable_mode_idx, address, addr_type)
/**Configure I/O-port interrupts**/
#define ble_cmd_hardware_io_port_config_irq(port, enable_bits, falling_edge)                       \
    ble_send_message (ble_cmd_hardware_io_port_config_irq_idx, port, enable_bits, falling_edge)
/**Set soft timer to send events**/
#define ble_cmd_hardware_set_soft_timer(time, handle, single_shot)                                 \
    ble_send_message (ble_cmd_hardware_set_soft_timer_idx, time, handle, single_shot)
/**Read A/D conversion**/
#define ble_cmd_hardware_adc_read(input, decimation, reference_selection)                          \
    ble_send_message (ble_cmd_hardware_adc_read_idx, input, decimation, reference_selection)
/**Configure I/O-port direction**/
#define ble_cmd_hardware_io_port_config_direction(port, direction)                                 \
    ble_send_message (ble_cmd_hardware_io_port_config_direction_idx, port, direction)
/**Configure I/O-port function**/
#define ble_cmd_hardware_io_port_config_function(port, function)                                   \
    ble_send_message (ble_cmd_hardware_io_port_config_function_idx, port, function)
/**Configure I/O-port pull-up/pull-down**/
#define ble_cmd_hardware_io_port_config_pull(port, tristate_mask, pull_up)                         \
    ble_send_message (ble_cmd_hardware_io_port_config_pull_idx, port, tristate_mask, pull_up)
/**Write I/O-port**/
#define ble_cmd_hardware_io_port_write(port, mask, data)                                           \
    ble_send_message (ble_cmd_hardware_io_port_write_idx, port, mask, data)
/**Read I/O-port**/
#define ble_cmd_hardware_io_port_read(port, mask)                                                  \
    ble_send_message (ble_cmd_hardware_io_port_read_idx, port, mask)
/**Configure SPI**/
#define ble_cmd_hardware_spi_config(channel, polarity, phase, bit_order, baud_e, baud_m)           \
    ble_send_message (                                                                             \
        ble_cmd_hardware_spi_config_idx, channel, polarity, phase, bit_order, baud_e, baud_m)
/**Transfer SPI data**/
#define ble_cmd_hardware_spi_transfer(channel, data_len, data_data)                                \
    ble_send_message (ble_cmd_hardware_spi_transfer_idx, channel, data_len, data_data)
/**Read data from I2C bus using bit-bang in cc2540. I2C clk is in P1.7 data in P1.6. Pull-up must be
 * enabled on pins**/
#define ble_cmd_hardware_i2c_read(address, stop, length)                                           \
    ble_send_message (ble_cmd_hardware_i2c_read_idx, address, stop, length)
/**Write data to I2C bus using bit-bang in cc2540. I2C clk is in P1.7 data in P1.6. Pull-up must be
 * enabled on pins**/
#define ble_cmd_hardware_i2c_write(address, stop, data_len, data_data)                             \
    ble_send_message (ble_cmd_hardware_i2c_write_idx, address, stop, data_len, data_data)
/**Set TX Power**/
#define ble_cmd_hardware_set_txpower(power)                                                        \
    ble_send_message (ble_cmd_hardware_set_txpower_idx, power)
/**Set comparator for timer channel**/
#define ble_cmd_hardware_timer_comparator(timer, channel, mode, comparator_value)                  \
    ble_send_message (ble_cmd_hardware_timer_comparator_idx, timer, channel, mode, comparator_value)
/**Enable I/O-port interrupts**/
#define ble_cmd_hardware_io_port_irq_enable(port, enable_bits)                                     \
    ble_send_message (ble_cmd_hardware_io_port_irq_enable_idx, port, enable_bits)
/**Set I/O-port interrupt direction**/
#define ble_cmd_hardware_io_port_irq_direction(port, falling_edge)                                 \
    ble_send_message (ble_cmd_hardware_io_port_irq_direction_idx, port, falling_edge)
/**Enable or disable analog comparator**/
#define ble_cmd_hardware_analog_comparator_enable(enable)                                          \
    ble_send_message (ble_cmd_hardware_analog_comparator_enable_idx, enable)
/**Read analog comparator output**/
#define ble_cmd_hardware_analog_comparator_read()                                                  \
    ble_send_message (ble_cmd_hardware_analog_comparator_read_idx)
/**Configure analog comparator interrupt**/
#define ble_cmd_hardware_analog_comparator_config_irq(enabled)                                     \
    ble_send_message (ble_cmd_hardware_analog_comparator_config_irq_idx, enabled)
/**Set RX Sensitivity**/
#define ble_cmd_hardware_set_rxgain(gain) ble_send_message (ble_cmd_hardware_set_rxgain_idx, gain)
/**Enable or disable USB**/
#define ble_cmd_hardware_usb_enable(enable)                                                        \
    ble_send_message (ble_cmd_hardware_usb_enable_idx, enable)
/**Start packet transmission, send one packet at every 625us**/
#define ble_cmd_test_phy_tx(channel, length, type)                                                 \
    ble_send_message (ble_cmd_test_phy_tx_idx, channel, length, type)
/**Start receive test**/
...
/**Debug command**/
#define ble_cmd_test_debug(input_len, input_data)                                                  \
    ble_send_message (ble_cmd_test_debug_idx, input_len, input_data)
...
#define ble_cmd_dfu_flash_set_address(address)                                                     \
    ble_send_message (ble_cmd_dfu_flash_set_address_idx, address)
/**Upload binary for flashing. Address will be updated automatically.**/
#define ble_cmd_dfu_flash_upload(data_len, data_data)                                              \
    ble_send_message (ble_cmd_dfu_flash_upload_idx, data_len, data_data)
...
#define ble_cmd_dfu_flash_upload_finish() ble_send_message (ble_cmd_dfu_flash_upload_finish_idx)
    ...
    /**Read data from I2C bus using bit-bang in cc2540. I2C clk is in P1.7 data in P1.6. Pull-up
     * must be enabled on pins**/
    void ble_rsp_hardware_i2c_read (const struct ble_msg_hardware_i2c_read_rsp_t *msg);

    /**Write data to I2C bus using bit-bang in cc2540. I2C clk is in P1.7 data in P1.6. Pull-up must
     * be enabled on pins**/
