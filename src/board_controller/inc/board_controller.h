...
extern "C"
{
    ...
    SHARED_EXPORT int CALLING_CONVENTION config_board (const char *config, int config_len,
        char *response, int *response_len, int board_id, const char *json_brainflow_input_params);
