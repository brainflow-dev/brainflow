...
if (MSVC)
    ...
    file (COPY "${CMAKE_HOME_DIRECTORY}/third_party/neurosdk/lib/${NEUROSDK_LIB_NAME}.dll" DESTINATION "${CMAKE_HOME_DIRECTORY}/swift-package/brainflow/lib/")
endif (MSVC)
if (APPLE)
    ...
    file (COPY "${CMAKE_HOME_DIRECTORY}/third_party/neurosdk/lib/lib${NEUROSDK_LIB_NAME}.dylib" DESTINATION "${CMAKE_HOME_DIRECTORY}/swift-package/brainflow/lib/")
endif (APPLE)
