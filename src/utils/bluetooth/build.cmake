...
if (UNIX AND NOT ANDROID)
    add_custom_command (TARGET ${BLUETOOTH_LIB_NAME} POST_BUILD
        ...
        COMMAND "${CMAKE_COMMAND}" -E copy_if_different "${CMAKE_CURRENT_SOURCE_DIR}/compiled/${BLUETOOTH_LIB_COMPILED_NAME}" "${CMAKE_CURRENT_SOURCE_DIR}/swift_package/BrainFlowCI/Frameworks/${BLUETOOTH_LIB_COMPILED_NAME}"
