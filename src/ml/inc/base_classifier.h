...
public:
    ...
    // BaseClassifier::ml_logger should not be called from destructors, to ensure that there are safe log
    // methods BaseClassifier::ml_logger still available but should be used only outside destructors
